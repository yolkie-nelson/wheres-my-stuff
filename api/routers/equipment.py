...
@router.get("/api/equipments/{serial_number}", response_model=Optional[EquipmentOut])
...
@router.put("/api/equipments/{serial_number}", response_model=Union[EquipmentOut, Error])
