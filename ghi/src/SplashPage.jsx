...
const SplashPage = () => {
    return (
        <div className="container mx-auto flex flex-col items-center justify-center pt-20">
            <h2 className="text-4xl font-bold mb-8">Welcome to Where&rsquo;s My Stuff</h2>
            <div className="flex items-center justify-center mb-8">
                ...
                <div className="flex-shrink-0 w-1/3 p-8">
                    <div className="mb-4">
                        <p className="mb-4">
                            Manage your inventory smarter, faster, and with ease. Where&rsquo;s My Stuff offers powerful tools tailored to your business needs, enabling you to streamline operations, reduce costs, and improve overall performance.
                        </p>
                        <p className="mb-4">
