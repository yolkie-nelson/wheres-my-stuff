    ...
    return (
        <><nav className="bg-gray-800">
            <div class=" nav-bar-font grid grid-rows-5 grid-cols-12 gap-1 w-full items-center justify-start sm:items-stretch sm:justify-start">
                ...
                {!account && <div className="flex justify-end pr-10 space-x-4 col-start-12 row-start-3"> <a href="#" className="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Login</a> </div>}
            </div>
            {/* <!--
